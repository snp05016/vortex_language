...
| [A3. Floats and vectors in registers](a3-floats-and-vectors.md) | Floating-point and SIMD registers, scalar FP instructions, FMA and contraction, and a first look at lanes. | Published |
...
| [C6. Instruction scheduling](c6-scheduling.md) | Latency, throughput and list scheduling, and why the naive matmul loop is latency-bound. | Published |
...
| [E4. Testing back ends](e4-testing-backends.md) | FileCheck on assembly, MIR tests, llvm-mc encoding tests and differential testing. | Published |
